function words(x)
{
    ...
    case 6:
        var word = new
        Array("higngual","hauling","haling","hail","nail","haul","hi","ha","gal","nah","gun", "lung","gang","hula","align","laugh");
        break;
    case 7:
        var word = new
        Array("negsrts","argents","garnets","strange","greats","angers","argent","garnet","rants", "earns","stern","rates","neats","tears","gears","agents","grant","anger","sage","rats","ears", "earn","rest","sent","seat","sear","seat");
        break;
    case 8:
        var word = new
        Array("ifenk", "knife", "fine", "if", "ink", "kin","fink");
        break;
	}
	return word;
}
